...
+ (void)fetchVideoListWithCompletionBlock:(void (^)(NSArray<ItemModel *> * _Nullable, NSError * _Nullable))completionBlock
{
    ...
    [[sharedSession dataTaskWithURL:[NSURL URLWithString:@"https://www.xiongdianpku.com/api/bytedance/video/list&tag=group_232"] completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
